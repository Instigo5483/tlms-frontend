                        ...
                        <div key={f.name}>
                          ...
                          {f.type === 'textarea' ? (
                            ...
                            <select
                              ...
                              style={{ width: '100%', padding: '4px 0', background: 'rgba(255,255,255,0.04) !important', border: '1px solid rgba(6,182,212,0.15) !important', borderRadius: '10px !important', color: '#fff !important', fontSize: '0.9rem' }}
                            >
