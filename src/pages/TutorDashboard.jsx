  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      ...
      <main style={{ padding: '96px 2.5rem 4rem', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          <div style={{ width: '48px', height: '48px', borderRadius: '14px', flexShrink: 0, background: '#ecfeff', border: '1px solid #a5f3fc', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '1rem', color: ACCENT }}>{initials}</div>
          <div>
          ...
          <span style={{ marginLeft: 'auto', fontSize: '0.72rem', fontWeight: 600, padding: '4px 12px', borderRadius: '999px', background: '#ecfeff', border: '1px solid #a5f3fc', color: ACCENT, whiteSpace: 'nowrap' }}>Tutor</span>
        </motion.div>
        ...
        >
          {[
            ...
            { label: 'Requests', value: pending.length, color: '#db2777' },
            { label: 'Subjects', value: loadedProfile?.subjects?.length || 0, color: '#059669' },
                      ...
                      {loadedProfile.subjects?.length > 0 && (
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                          {loadedProfile.subjects.map(s => (
                            <span key={s} style={{ background: '#ecfeff', border: '1px solid #a5f3fc', color: ACCENT, fontSize: '0.78rem', padding: '3px 10px', borderRadius: '6px' }}>{s}</span>
                          ))}
                        </div>
                      )}
